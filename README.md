...
| `BOJ_11718_PrintAsIs`              | 입력이 들어오지 않을때 자동으로 종료 되는 로직 구현                                                                                   |
| `BOJ_11718_PrintAsIs`              | 입력이 들어오지 않을때 자동으로 종료 되는 로직 구현                                                                                   |
| `BOJ_25083_Sprout`                 | \출력이나 “출력하는 문제                                                                                                  |
| `BOJ_3003_Chess`                   | 배열을 가지고 연산을 하는 문제                                                                                               |
| `BOJ_2444_Star`                    | 반복문의 조건을 잘 분석하고 패턴을 잘  생각해서 풀어야하는 문제                                                                            |
| `BOJ_10988_Palindrome`             | 문자열 처리 및 기본적인  사고력을 물어보는 문제                                                                                     |
| `BOJ_1157_StudyWord`               | 숫자열을 문자열로 문자열을 숫자열로 다시 바꾸는게 중요했던 문제  최댓값에 따른 스왑도 생각해야했음                                                                           |
| `BOJ_2941_CAlphabet`               | 입력을 재배치해서 갯수를 세는 아이디어가 필요했던 문제|
| `BOJ_1316_GroupWordChecker`        | 배열을 만들어서 위치를 기억하는 로직을 만드는게 어려웠던 문제 |
| `BOJ_25206_YourScore`              | Map 또는 if else를 사용해서 등급에 따른 학점을 넣어주는 문제 |
| `BOJ_2738_ArrayPlus`               | 2차원 배열 과 for 중첩문을 사용해서 해결하는 문제 |
| `BOJ_2566_Max`                     | 2차원 배열에 최댓값 구한는 스왑을 적용하는문제 |
| `BOJ_10798_LengthRead`             | 문자열 + 인덱스처리 능력 확인하는 문제 |
...
>>>>>>> 53c68bd4c7fb5fd0d0430b289e4869ccdd6a1b58
